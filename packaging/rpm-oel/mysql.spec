...
# Pass path to LDAP lib
%{?with_ldap: %global ldap_option -DWITH_LDAP=%{with_ldap}}
%{?with_ldap: %global ldap 1}

# Pass path to SASL lib
%{?with_sasl: %global sasl_option -DWITH_SASL=%{with_sasl}}
%{?with_sasl: %global sasl 1}
...
Source7:        %{compatsrc}
%endif
Source10:       https://downloads.sourceforge.net/boost/boost_1_59_0.tar.bz2
