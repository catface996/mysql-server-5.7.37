...
xdr_node_set(XDR *xdrs, node_set *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->node_set_val, (u_int *)&objp->node_set_len, 100, sizeof(bool_t), (xdrproc_t)xdr_bool))
		return (FALSE);
	return (TRUE);
}
...
xdr_node_list_1_0(XDR *xdrs, node_list_1_0 *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->node_list_1_0_val, (u_int *)&objp->node_list_1_0_len, 100, sizeof(node_address_1_0), (xdrproc_t)xdr_node_address_1_0))
		return (FALSE);
	return (TRUE);
}
...
xdr_node_list(XDR *xdrs, node_list *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->node_list_val, (u_int *)&objp->node_list_len, 100, sizeof(node_address), (xdrproc_t)xdr_node_address))
		return (FALSE);
	return (TRUE);
}
/*
...
xdr_node_no_array(XDR *xdrs, node_no_array *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->node_no_array_val, (u_int *)&objp->node_no_array_len, 100, sizeof(node_no), (xdrproc_t)xdr_node_no))
		return (FALSE);
	return (TRUE);
}
...
xdr_synode_no_array(XDR *xdrs, synode_no_array *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->synode_no_array_val, (u_int *)&objp->synode_no_array_len, 1024, sizeof(synode_no), (xdrproc_t)xdr_synode_no))
		return (FALSE);
	return (TRUE);
}
...
xdr_app_data_ptr_array(XDR *xdrs, app_data_ptr_array *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->app_data_ptr_array_val, (u_int *)&objp->app_data_ptr_array_len, 1024, sizeof(app_data_ptr), (xdrproc_t)xdr_app_data_ptr))
		return (FALSE);
	return (TRUE);
}
...
xdr_bit_set(XDR *xdrs, bit_set *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->bits.bits_val, (u_int *)&objp->bits.bits_len, 100, sizeof(bit_mask), (xdrproc_t)xdr_bit_mask))
		return (FALSE);
	return (TRUE);
}
...
xdr_configs(XDR *xdrs, configs *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->configs_val, (u_int *)&objp->configs_len, 100, sizeof(config_ptr), (xdrproc_t)xdr_config_ptr))
		return (FALSE);
	return (TRUE);
}
...
xdr_file_name_array(XDR *xdrs, file_name_array *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->file_name_array_val, (u_int *)&objp->file_name_array_len, 1024, sizeof(file_name), (xdrproc_t)xdr_file_name))
		return (FALSE);
	return (TRUE);
}
